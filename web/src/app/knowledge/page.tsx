...
export default async function OrgKnowledgePage() {
  ...
  const items: KnowledgeItemView[] = rows.map((r) => ({
    ...
    scopeLabel: r.projectId == null ? "Org-wide" : r.projectName ?? "Project",
    ...
    <main className="min-h-screen bg-neutral-50 text-neutral-900">
      <div className="w-full px-6 py-10">
        ...
        <p className="mt-1 text-sm text-neutral-500">
          Your organization&apos;s shared knowledge base. Every project&apos;s knowledge rolls up here, and you can add
          org-wide references directly. New projects draw on all of this — plus their own project knowledge — when
        ...
        <div className="mt-8">
          <KnowledgeClient
            ...
            emptyHint="No organization knowledge yet. Upload org-wide references, or add knowledge inside any project — it will roll up here."
          />
        </div>
      </div>
    </main>
